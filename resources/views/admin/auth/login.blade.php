...
<head>
    ...
    <title>Laravel CRUD | Admin Login</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{ route('admin.get.company') }}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">LARAVEL CRUD</span>
                            </a>
                        </div>
                        <!-- /Logo -->
