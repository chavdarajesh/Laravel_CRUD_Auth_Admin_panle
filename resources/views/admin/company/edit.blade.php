...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="card-header justify-content-between d-flex">
            <div class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Company /</span> All Companies / Edit Company
            </div>
        </h5>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                        <form id="company_form" method="POST" action="{{ route('admin.update.company',$Company->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
